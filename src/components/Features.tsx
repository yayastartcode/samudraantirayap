...
const features = [
    ...
    },
    {
        ...
        title: 'GARANSI 3 S.D 5 TAHUN',
        description: 'Kami memberikan garansi layanan 3 sampai 5 tahun untuk memastikan perlindungan optimal rumah Anda dari serangan rayap.',
    },
    {
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
